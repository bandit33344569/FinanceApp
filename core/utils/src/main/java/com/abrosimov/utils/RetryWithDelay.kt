...
/**
 * Повторяет выполнение suspend-функции, возвращающей [com.abrosimov.utils.models.Resource], при возникновении ошибки.
 *
 ...
 * @param block Блок кода, возвращающий [com.abrosimov.utils.models.Resource]. Обычно это вызов UseCase или API.
 * @return Результат типа [com.abrosimov.utils.models.Resource]:
